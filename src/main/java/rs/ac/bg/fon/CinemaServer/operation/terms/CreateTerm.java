...
/**
 * System operation that creates a Term record in the database.
...
public class CreateTerm extends AbstractGenericOperation{
    ...
    /**
     * Executes the operation by calling the add method on the repository attribute for saving the term.
     * @param param Object that is sent as request argument.
