...
public class ReadTermsTest {
	private AbstractGenericOperation readTerms;
	...
	void constructorTest() {
		readTerms = new ReadTerms();
		assertNotNull(readTerms);
	}
	
	@Test
	void testPreconditionsNull() {
		assertThrows(java.lang.Exception.class, () -> readTerms.execute(null));
	}
	
	@Test
	void testPreconditionsInvalidData() {
		assertThrows(java.lang.Exception.class, () -> readTerms.execute(new Film()));
	}
