...
public class DeleteReservationTest {
	private AbstractGenericOperation deleteReservation;
	...
	void constructorTest() {
		deleteReservation = new DeleteReservation();
		assertNotNull(deleteReservation);
	}
	
	@Test
	void testPreconditionsNull() {
		assertThrows(java.lang.Exception.class, () -> deleteReservation.execute(null));
	}
	
	@Test
	void testPreconditionsInvalidData() {
		assertThrows(java.lang.Exception.class, () -> deleteReservation.execute(new Film()));
	}
	...
	void testDeleteReservation() throws Exception {
		...
		AbstractGenericOperation readReservationWhere = new ReadReservationsWhere(" termID = 62 and userID = 5 and number = 1");
		...
		deleteReservation.execute(reservations.get(0));
		
		readReservationWhere = new ReadReservationsWhere(" termID = 62 and userID = 5 and number = 1");
		readReservationWhere.execute(new Reservation());
		reservations = ((ReadReservationsWhere)readReservationWhere).getList();
